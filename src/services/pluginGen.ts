...
export const PLUGIN_SYSTEM = [
  ...
  'localStorage/cookies THROW there. For persistence use the storage bridge',
  'below (it falls back to localStorage when the plugin runs standalone).',
  '',
  'Storage bridge — include this and use BS instead of localStorage:',
  ...
  'Await BS.ready before your first read (values are strings, like localStorage).',
  '',
